...
// Define the structure of the props for the email template
interface DataStats {
  totalIncome: number;
      ...
      <Html>
        ...
        <Body style={styles.body}>
          <Container style={styles.container}>
            ...
            {data.insights && (
              <Section style={styles.section}>
                <Heading style={styles.heading}>Xpense Insights</Heading>
            ...
            <Text style={styles.footer}>
              Thank you for using Xpense. Keep tracking your finances for better
              financial health!
            </Text>
          </Container>
        </Body>
